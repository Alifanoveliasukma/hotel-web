                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <a class="btn btn-success update-pro"data-toggle="modal" data-target="#tambahKamar" > <span>Tambah Kamar</span></a>
                            <!-- Modal -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-heading">
                                <!-- Button trigger modal -->
                                <a class="btn btn-success update-pro"data-toggle="modal" data-target="#tambahFasilitas" > <span>Tambah Fasilitas</span></a>
                                <!-- Modal -->
...
<div class="modal fade" id="tambahKamar" tabindex="-1" role="dialog" aria-labelledby="cekStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                <label for="nama_fasilitas">Tipe Kamar</label>
                <input type="text" class="form-control" name="tipe_kamar">
            </div>
            <div class="form-group">
                <label for="tipe_kamar">No Kamar</label>
